            ...
            <div className="group border-2 border-brass bg-card/95 backdrop-blur-sm rounded-3xl shadow-xl overflow-hidden hover:shadow-2xl hover:-translate-y-2 transition-all duration-300">
              <Link to="/apps/bundle-builder" className="block">
                <div className="h-64 bg-gradient-to-br from-brass to-aged-wood flex items-center justify-center p-6">
                  <AppIcon app="bundle-builder" size="lg" className="!h-28 !w-28" />
                </div>
              </Link>
              <div className="p-8 flex flex-col gap-4">
                <h3 className="text-3xl font-semibold text-foreground">Bundle Builder</h3>
                <p className="text-lg text-muted-foreground flex-grow">Mix & match or quantity discounts – instant AOV boosts.</p>
                <AddToShopifyButton appSlug="bundle-builder" className="w-full sm:w-auto sm:min-w-[200px] justify-center" />
                <Link to="/apps/bundle-builder" className="text-brass font-medium hover:underline text-center sm:text-left">
                  Learn more →
                </Link>
              </div>
            </div>
